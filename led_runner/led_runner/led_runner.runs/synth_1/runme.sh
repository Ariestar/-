...
HD_PWD='D:/Vivado2018/led_runner/led_runner.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_runner.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_runner.tcl
