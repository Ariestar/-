...
HD_PWD='D:/Vivado2018/led_runner/led_runner.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_runner.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_runner.tcl -notrace
